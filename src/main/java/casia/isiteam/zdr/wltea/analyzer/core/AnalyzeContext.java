...
import casia.isiteam.zdr.wltea.analyzer.dic.Dictionary;
...
class AnalyzeContext {
    ...
    void initCursor() {
        this.cursor = 0;
        this.segmentBuff[this.cursor] = CharacterUtil.regularize(this.segmentBuff[this.cursor], cfg.isEnableLowercase()); // cfg NULL POINTER EXCEPTION
